...
# ==============================
# Layout: sticky right panel for logging
# ==============================
col1, col2 = st.columns([2, 1])

# ------------------------------
# LEFT COLUMN → Blockchain & Journey
# ------------------------------
with col1:
    ...
    if st.button("View Journey"):
        # Filter only Customer transactions for status view
        customer_journey = [
            {
        ...
        if customer_journey:
            ...
            st.dataframe(pd.DataFrame(customer_journey).style.set_properties(**{
            ...
            st.dataframe(pd.DataFrame(customer_records).style.set_properties(**{
...
# ------------------------------
# RIGHT COLUMN → Log New Step (Sticky)
# ------------------------------
with col2:

...
# ==============================
# RIGHT SIDE → Log Payment Method in Sidebar
# ==============================
with st.sidebar:
    st.subheader("📝 Log Payment Method")

    product_id = st.text_input("Product ID for Payment")
    product_name = st.text_input("Product Name")
    actor_name = st.text_input("Customer Name")
